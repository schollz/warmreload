...
mod.hook.register("script_pre_init","pre cleanup",function()
  print("[hotreload] starting")
  os.execute("/home/we/dust/code/warmreload/run.sh &")

end)

mod.hook.register("script_post_cleanup","post cleanup",function()
  print("[hotreload] cleaup")
  os.execute("pkill -f warmreload")
end)
